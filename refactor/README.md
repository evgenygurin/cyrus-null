...
> **⚠️ ВАЖНО**: Эта документация интегрирована с основной документацией.  
> **См. главный документ для агентов**: [`docs/AGENT_INSTRUCTIONS.md`](../docs/AGENT_INSTRUCTIONS.md)  
> **См. Codegen-специфичные инструкции**: [`docs/CODEGEN_AGENT_INSTRUCTIONS.md`](../docs/CODEGEN_AGENT_INSTRUCTIONS.md)
